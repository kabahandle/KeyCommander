...
c:\220again\dos220\dosbox.exe -conf "c:\\220again\\dos220\\dosbox.conf" -c "mount c c:\\220again" -c "c:\\dos220\\chej\\chej jp" -c "mount d m:\\cygwin64" -c "mount m m:\\ " -c "mount g g:\\ " -c " %drv% " -c "cd %d% " -c "%pg%"
